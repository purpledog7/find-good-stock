...
DAY_SWING_CANDIDATE_POOL_N = 100
DAY_SWING_SHORTLIST_N = 20
DAY_SWING_FINAL_N = 5
DAY_SWING_NEWS_MAX_ITEMS_DEFAULT = 50
DAY_SWING_NEWS_START_HOUR = 16
DAY_SWING_NEWS_START_MINUTE = 0
DAY_SWING_NEWS_CUTOFF_HOUR = 8
DAY_SWING_NEWS_CUTOFF_MINUTE = 0
DAY_SWING_HISTORY_TRADING_DAYS = SPECIAL_SWING_HISTORY_TRADING_DAYS
FUTURE_VALUE_MAX_PRICE = 5_000
FUTURE_VALUE_NEWS_MAX_ITEMS_DEFAULT = 30
FUTURE_VALUE_NEWS_LOOKBACK_DAYS = 90
FUTURE_VALUE_NEWS_TIME_BUDGET_SECONDS = 600.0
FUTURE_VALUE_CANDIDATE_LIMIT = 0
FUTURE_VALUE_PHASE2_TOP_N = 30
FUTURE_VALUE_PHASE2_WEB_MAX_ITEMS_DEFAULT = 10
